...
#
# Vendored from https://github.com/QwenLM/Qwen3-TTS/blob/main/finetuning/prepare_data.py
# (2026-07-14). Local change: --device now auto-detects cuda/mps/cpu instead of
# hardcoding "cuda:0", so this runs (slowly, on CPU/MPS) for a pipeline smoke test
# on machines without an NVIDIA/ROCm GPU. See ../../../docs/tts-finetuning.md.
